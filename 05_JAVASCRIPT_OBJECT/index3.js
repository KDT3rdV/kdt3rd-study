...
console.log(document.head); // head태그 반환
...
console.log(document.querySelector('.launch-list #third'));
console.log(document.querySelectorAll('.launch-list .korean'));
console.log(document.querySelectorAll('.launch-list li'));

console.log(document.querySelector('.launch-list .korean'));
console.log(document.querySelector('.launch-list li'));

console.log(document.querySelectorAll('.launch-list .korean #first'));
