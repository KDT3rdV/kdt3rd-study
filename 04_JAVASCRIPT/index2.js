...
let q1 = 3;
q1 - 2; // 3
// q1에서 2를 뺏지만, q1변수에 값을 재할당 하지 않았기 때문에 3

// Q2. 다음 코드 실행시 q2 변수는 어떤 값이 될까?
let q2 = 10;
q2 = q2 + 5; // 15
// q2변수에 재할당을 했기 때문에 15가 나오고 q2는 15로 됨
q2 = q2 - 2; // 13
// 위에서 q2가 15가 되었기 떄문에 재할당 완료 되서 13이 됨
...
//  - ex) const, let, var, void, return, for, while, if, else...
// 2. 숫자로 시작 불가능
// 3. 특수문자: _, $ 만 허용
// 4. 공백문자(space bar) 사용 불가능
